...
import { LayoutDashboard, PlusCircle, List, LogOut, Menu, X, Building2, Settings, Code, Users, Layout, Activity } from 'lucide-react';
...
export default function DashboardLayout() {
  ...
  if (user?.role === 'admin') {
    ...
    navigation.push({ name: 'Execuções FlowAI', href: '/flow-executions', icon: Activity });
